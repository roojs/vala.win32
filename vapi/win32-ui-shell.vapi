...
namespace Win32.Ui.Shell {
	...
	public delegate int64 SUBCLASSPROC (
		...
		ulong w_param,
		int64 l_param,
		[CCode(type_id = "UINT_PTR")] ulong u_id_subclass,
		[CCode(type_id = "UINT_PTR")] ulong dw_ref_data
	);
	...
	public interface IContextMenu : IUnknown {
		...
		public abstract int get_command_string (
			[CCode(type_id = "UINT_PTR")] ulong id_cmd,
			uint u_type,
			out uint p_reserved,
			void* psz_name,
			uint cch_max
	...
	public interface IShellTaskScheduler : IUnknown {
		...
		public abstract int add_task (
			IRunnableTask prt,
			void* rtoid,
			[CCode(type_id = "UINT_PTR")] ulong l_param,
			uint dw_priority
		);
	...
	public interface IVisualProperties : IUnknown {
		...
		public abstract int set_color (
			VPCOLORFLAGS vpcf,
			[CCode(type_id = "COLORREF")] uint cr
		);
	...
	public interface ICredentialProvider : IUnknown {
		...
		public abstract int advise (
			...
			[CCode(type_id = "UINT_PTR")] ulong up_advise_context
		);
	...
	public extern int get_window_subclass (
		...
		SUBCLASSPROC pfn_subclass,
		[CCode(type_id = "UINT_PTR")] ulong u_id_subclass,
		[CCode(type_id = "UINT_PTR")] out ulong pdw_ref_data
	);
	...
	public extern void** shalloc (
		[CCode(type_id = "UINT_PTR")] ulong cb
	);
	...
	public extern ulong shapp_bar_message (
		uint dw_message,
		out void* p_data
	);
	...
	public extern ulong shget_file_info (
		[CCode(type_id = "LPCWSTR")] uint16* psz_path,
	...
	public extern void* color_rgbto_hls (
		[CCode(type_id = "COLORREF")] uint clr_rgb,
		out ushort pw_hue,
	...
	public extern uint color_hlsto_rgb (
		ushort w_hue,
		ushort w_luminance,
		ushort w_saturation
	);
	...
	public extern uint color_adjust_luma (
		[CCode(type_id = "COLORREF")] uint clr_rgb,
		int n,
		int f_scale
	);
	...
	public extern int path_cch_add_backslash_ex (
		void* psz_path,
		[CCode(type_id = "UINT_PTR")] ulong cch_path,
		[CCode(type_id = "LPCWSTR")] out uint16* ppsz_end,
		[CCode(type_id = "UINT_PTR")] out ulong pcch_remaining
	);
	...
	public extern int path_cch_canonicalize_ex (
		void* psz_path_out,
		[CCode(type_id = "UINT_PTR")] ulong cch_path_out,
