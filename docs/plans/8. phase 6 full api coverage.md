# 8 — Phase 6: Full API coverage and testing

**Status:** **🔷** In progress — **6a ✅** · **6b ✅** · **6c ✅** · **6d ⏭ skipped** · **6e ✅** · **6f ⏳**

**Layout:** `~/gitlive/OLLMchat/docs/guide-to-writing-plans.md`

**Parent:** [1. project overview.md](1.%20project%20overview.md) · **After:** [7. DONE - phase 5 widget emit.md](7.%20DONE%20-%20phase%205%20widget%20emit.md) (**✅**) · **Before:** [9. phase 7 webview2 research and integration.md](9.%20phase%207%20webview2%20research%20and%20integration.md)
...
- `docs/plans/8. phase 6 full api coverage.md` — matrix + gap notes (this doc)
...
- **After Phase 6:** [9. phase 7 webview2 research and integration.md](9.%20phase%207%20webview2%20research%20and%20integration.md) — WebView2 (primary focus).
- **Then:** [10. phase 8 polish and ci.md](10.%20phase%208%20polish%20and%20ci.md) — Valadoc, CI, README (polish **after** Phases 6–7).
