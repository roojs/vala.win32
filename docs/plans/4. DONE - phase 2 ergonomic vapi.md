# 4 — Phase 2: Generated vapi + hello-window

**Status:** **✅** Done — Track A complete; Track B deferred to Phase 3/5

**Layout:** `~/gitlive/OLLMchat/docs/guide-to-writing-plans.md`

**Parent:** [1. project overview.md](1.%20project%20overview.md) · **Depends on:** [3. DONE - phase 1 metadata and generator.md](3.%20DONE%20-%20phase%201%20metadata%20and%20generator.md)
...
**ℹ️** [5. DONE - phase 3 common controls.md](5.%20DONE%20-%20phase%203%20common%20controls.md) — widen `win32json-api.files`, generator emit for Button/Edit, `BN_CLICKED` → `clicked`, on top of a working hello baseline.
