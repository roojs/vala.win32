...
**Parent:** [1. project overview.md](1.%20project%20overview.md) · **Depends on:** [4. DONE - phase 2 ergonomic vapi.md](4.%20DONE%20-%20phase%202%20ergonomic%20vapi.md) (hello-window on generated vapi)
...
- `docs/plans/5. DONE - phase 3 common controls.md` — this plan
...
- `README.md`, `docs/plans/5. DONE - phase 3 common controls.md`
...
- `docs/plans/4. DONE - phase 2 ergonomic vapi.md`, `docs/plans/5. DONE - phase 3 common controls.md`
...
**ℹ️** Parent: [1. project overview.md](1.%20project%20overview.md) § architecture · [4. DONE - phase 2 ergonomic vapi.md](4.%20DONE%20-%20phase%202%20ergonomic%20vapi.md) Track B notes.
...
- `README.md`, `docs/plans/5. DONE - phase 3 common controls.md` — maintainer flow
...
- `docs/plans/5. DONE - phase 3 common controls.md`
...
| Phase | Plan |
|-------|------|
| **4** | [6. DONE - phase 4 dialogs and resources.md](6.%20DONE%20-%20phase%204%20dialogs%20and%20resources.md) — **✅** done |
| **5** | [7. DONE - phase 5 widget emit.md](7.%20DONE%20-%20phase%205%20widget%20emit.md) — **✅** WidgetCodegen + catalog emit |
| **6** | [8. phase 6 full api coverage.md](8.%20phase%206%20full%20api%20coverage.md) — API coverage / testing |
| **7** | [9. phase 7 webview2 research and integration.md](9.%20phase%207%20webview2%20research%20and%20integration.md) — WebView2 |
| **8** | [10. phase 8 polish and ci.md](10.%20phase%208%20polish%20and%20ci.md) — Valadoc, CI, README |
